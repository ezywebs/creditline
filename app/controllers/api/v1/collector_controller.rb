module Api
  module V1
    class CollectorController < ApplicationController
      ...
      #   # credit_line.update(:last_statement => statement_ending + 1.days)
      
      #   render json: {status: "SUCCESS", message: "CollectorController is working", data: {interest: interest.round(2), balance: balance, credit_line: credit_line, transactions: transactions}}, status: :ok
      # end
